...
class KillerValueInput extends React.Component {
  ...
  drawKillerValue() {
    ...
    switch(selected_option) {
      ...
      case "multiple_option":
          ...
          return (
            <div style={ customStyles }>
              <Select isMulti={ multiple } options={ options } value={ this.validOptions(value) } onChange={ this.handleKillerValueChange } name={ `${name}[killer_value]` } />
            </div>
          )
      default:
  ...
  handleKillerValueChange(value) {
    this.setState({killer_value: value});
  }
